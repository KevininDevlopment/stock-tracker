...
public class StockTrackerDB
{
    ...
    private byte[] serializeObj(Object obj) throws IOException
    {
        ...
        objOStream.writeObject(obj);  // object must be Serializeable
        objOStream.flush();
        objOStream.close();
     ...
     { 
        ...
        {   
            ...
            { 
                ...
                // Mthods to access a complete record
                                                          ...
                                                          ClassNotFoundException
                {
                    ...
                    if(rs.next())
                    {
                        ...
                        user = new User(dbUserID,dbFirstName,dbLastName,isAdmin);
